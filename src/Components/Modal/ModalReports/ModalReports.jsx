...
const Backdrop = ({  onClose })  => {
  ...
  return (
    <div className={classes.backdrop} onClick={onCloseReportModal}></div>
  );
};
  ...
  return(
      <div className={`col-md-6 p-5 ${classes.modal}`}>
          <div className="d-flex justify-content-between align-items-center border-bottom border-dark">
            ...
            <p><i className="fas fa-times-circle" onClick={onCloseReportModal}></i></p>
          </div>
...
const ModalReports = props => {
  ...
  return(
    <Fragment>
      ...
      {ReactDOM.createPortal(<ModalReportsOverlay report={props.report[0]} onClose={props.onClose}  />, document.getElementById("modal-overlay"))}
    </Fragment>
