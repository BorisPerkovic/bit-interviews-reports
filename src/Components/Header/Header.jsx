    ...
    return(
        <Fragment>
            {path && (<header className='container d-flex justify-content-between align-items-center p-4'>
                ...
                <Link to="/reports"><button type='button' className='btn btn-info'>Reports</button></Link> 
                <Link to="/logout"><button type='button' className='btn btn-info'>Log Out</button></Link> 
            </header>)}
        </Fragment>   
    );
